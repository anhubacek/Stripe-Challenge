...
export default function Preview() {
  ...
  }${device.desktop === true ? "&desktop=true" : ""}${
    device.mobile === true ? "&mobile=true" : ""
  }${language[0] === "en" ? "&lan=en" : ""}${
    language[0] === "es" ? "&lan=es" : ""
  }`;
          ...
          <div className={styles.OptionsDashboard}>
            ...
            <button className={styles.Language}>
              ...
              <label>
                Customer location{" "}
                <Popover
                  content="Checkout adapts to your costumer's location and preferences to show the language and payment methods most likely to increase conversion."
