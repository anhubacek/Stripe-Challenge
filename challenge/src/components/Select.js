  ...
  return (
    <div className={styles.SelectPage}>
      <div className={styles.NavBarContent}>
        ...
        <a
          style={
            option.recurringPayments
              ? { background: "#c9c2c2", cursor: "not-allowed" }
              : {}
          }
          href={option.oneTimePayments === true ? "/configure" : "/"}
          className={
            option.oneTimePayments === true ? styles.NextStep : styles.disabled
          }
        >
          <span>Next</span>
